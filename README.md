...
- Cambios visuales de HTML/CSS/JS deben subir `VERSION`; el modal de items usa rejilla de 3 columnas en escritorio, QR compacto y campos agrupados desde `v120`. La tabla de inventario usa placeholder de foto reducido, utilidad truncada y nombre clicable desde `v122`. Las categorias se ordenan alfabeticamente y pueden crearse desde el selector del item desde `v123`.
